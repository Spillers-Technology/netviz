...
| STD-003 doc freshness | not-yet (narrowed) | `CHANGELOG.md` is now explicitly the sole release-notes source and historical per-version notes are retired, but README still does not state current v0.9.5. |
